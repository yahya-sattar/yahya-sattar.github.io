...
title: home
permalink: /
# subtitle: <a href='#'>Cornell University</a>. Address. Contacts. Motto. Etc.
...
My research interests revolve broadly around the statistical and algorithmic aspects of <strong>sequential learning</strong> and <strong>decision making</strong> in dynamic settings, with applications in robotics, autonomous systems, and broader scientific and engineering domains. More precisely, I study the learning and inference problems arising in <strong><font color="CornflowerBlue">Optimal Control</font></strong>, <strong><font color="CornflowerBlue">Reinforcement Learning</font></strong>, and <strong><font color="CornflowerBlue">Machine Learning</font></strong>, using tools and concepts from <strong><font color="FireBrick">Statistical Learning</font></strong>, <strong><font color="FireBrick">Optimization</font></strong>, and <strong><font color="FireBrick">Control Theory</font></strong>.
